...
d = deque([1, 2, 3])
print(d)
d.appendleft(4)  # ajout de la valeur à l'indice 0
print(d)
d.popleft()  # suppression de la valeur à l'indice 0
print(d)
d.extendleft([4, 3, 2])  # ajout de valeurs à gauche du deque mais par odre inversée
print(d)
